...
import Notifycase from '@salesforce/apex/B2BGetInfo.Notifycase';
...
export default class ProductDetailsDisplay extends NavigationMixin(
    ...
    CaseDescr = 'Notify when product is available';
    notifyMe(){

        Notifycase({descr:this.CaseDescr, userId:this.userId})
